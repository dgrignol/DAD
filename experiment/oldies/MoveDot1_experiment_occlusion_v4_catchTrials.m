% MoveDot1_experiment_occlusion_v4_catchTrials.m
%
% Purpose:
...
%   MoveDot1_experiment_occlusion_v4_catchTrials
%
...
%    run('MoveDot1_experiment_occlusion_v4_catchTrials.m');"
%
% Inputs:
...
%
% Outputs:
%   - experiment/output_files/MoveDot1_occlusion_v4_catchTrials_SUBXX_BLOCKYY.mat
%   - experiment/output_files/debug_actual_triggers_occlusion_v4_subXX_blockYY_runZZ.csv (debug mode)
%
% Assumptions:
...
Conf.experimentName = 'MoveDot1_occlusion_v4_catchTrials';
...
Conf.fixSizeDeg = 0.2;
Conf.showFixCrossBetweenTrials = 0; % kept for compatibility; not used in post-trial v4 ITI.
...
if ~(exist('iSub', 'var') && exist('iBlock', 'var') && exist('viewingDistanceMm', 'var'))
    ...
    dlgtitle = 'Occlusion v4 (catch trials + block breaks) input';
    dims = [1 50];
    definput = {'70', '1', '1000'};
...
if ndims(tsData.TrialOrder) ~= 3
    error('TrialOrder in %s must be 3D [block x trial x run] for v4 block mode.', ...
        trialStructFile);
end
    ...
    for iBlockIdx = 1:numel(blocksToExecute)
        ...
        for iRunIdx = 1:numel(runsToExecute)
            ...
            for iTrial = 1:nTrials
                ...
                % No pre-trial pause in v4 block-break mode:
            ...
            if Conf.debug || ~isempty(debugTriggerLog)
                debugTriggerFile = fullfile(outputDir, sprintf( ...
                    'debug_actual_triggers_occlusion_v4_sub%02d_block%02d_run%02d.csv', ...
...
% LOCAL_PRESENT_POST_TRIAL_INTERVAL Present the v4 inter-trial sequence.
%
% Sequence:

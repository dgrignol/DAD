% MoveDot1_experiment_occlusion_v11_practiceByRun.m
%
% Purpose:
...
%   - Switch source:
%       Config_schedule_CreateInputV15_MoveDotV11.runColorCueEnabled
%       (set true by default in v11 config).
%
% Message flow additions in v11:
%   - Start gate message:
...
%
% Practice mode additions in v11:
...
%   MoveDot1_experiment_occlusion_v11_practiceByRun
%
...
%    run('MoveDot1_experiment_occlusion_v11_practiceByRun.m');"
%
% Inputs:
...
%
% Outputs:
%   - experiment/output_files/MoveDot1_occlusion_v11_practiceByRun_SUBXX_BLOCKYY.mat
%   - experiment/output_files/debug_actual_triggers_occlusion_v11_subXX_blockYY_runZZ.csv (debug mode)
%
% Assumptions:
...
scheduleCfg = Config_schedule_CreateInputV15_MoveDotV11;
if scheduleCfg.runsPerBlock ~= 3
    error('Config_schedule_CreateInputV15_MoveDotV11.runsPerBlock must be 3 for this runtime.');
end
...
Conf.experimentName = 'MoveDot1_occlusion_v11_practiceByRun';
...
% Start gate and run-transition messages (v11 additions).
...
if ~(exist('iSub', 'var') && exist('iBlock', 'var') && exist('viewingDistanceMm', 'var') && exist('practice_mode', 'var'))
    ...
    dlgtitle = 'Occlusion v11 (practice by run) input';
    dims = [1 50];
...
if ndims(tsData.TrialOrder) ~= 3
    error('TrialOrder in %s must be 3D [block x trial x run] for v11 block mode.', ...
        trialStructFile);
end
    ...
    for iBlockIdx = 1:numel(blocksToExecute)
        ...
        for iRunIdx = 1:numel(runsToExecute)
            ...
            for iTrial = 1:nTrials
                ...
                % No pre-trial pause in v11 block-break mode:
            ...
            if Conf.debug || ~isempty(debugTriggerLog)
                debugTriggerFile = fullfile(outputDir, sprintf( ...
                    'debug_actual_triggers_occlusion_v11_sub%02d_block%02d_run%02d.csv', ...
...
% LOCAL_PRESENT_POST_TRIAL_INTERVAL Present the v11 inter-trial sequence.
%
% Sequence:

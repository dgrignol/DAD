# Trigger Codes (MoveDot1_experiment_occlusion_v5_sequenceTriggers)
...
**Notes**
- This trigger map is specific to `experiment/MoveDot1_experiment_occlusion_v5_sequenceTriggers.m`.

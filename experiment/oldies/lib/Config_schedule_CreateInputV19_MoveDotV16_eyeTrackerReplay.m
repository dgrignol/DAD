classdef Config_schedule_CreateInputV19_MoveDotV16_eyeTrackerReplay
    properties(Constant)

        % CONFIG_SCHEDULE_CREATEINPUTV19_MOVEDOTV16_PATHBANDOCCLUDER
        %
        % Purpose:
        %   Centralize block/run schedule controls and catch-trial controls
        %   for:
        %     - experiment/CreateInputFiles_v19_threeRunsPerBlock_catch_eyeTrackerReplay.m
        %     - experiment/MoveDot1_experiment_occlusion_v16_eyeTrackerReplay.m
        %
        % Usage example (interactive):
        %   In MATLAB, open this file and set:
        %       Config_schedule_CreateInputV19_MoveDotV16_eyeTrackerReplay.numBlocks
        %   then run:
        ...
        % Run-color cue switch for experiment v16.
        ...
        % Eye-tracker controls for MoveDot1_experiment_occlusion_v16_eyeTrackerReplay.
        ...
        % If true, attempt EDF file retrieval on cleanup in non-practice runs.
        eyeTrackerReceiveFileAfterRun = true;
        % Path to fixation bitmap used for EyeLink host image transfer.
        eyeTrackerFixBmpPath = './fixation.bmp';

        % Input/output naming for additive v19 schedule artifacts.
        % Input stimulus filename pattern.
        % Example: subject 66 -> MovDot_Sub66_V26_eyeTrackerReplay.mat
        inputFilePattern = 'MovDot_Sub%02d_V26_eyeTrackerReplay.mat';
        % Output schedule filename pattern.
        % Example: subject 66 -> Sub66_TrialStruct_v19_threeRunsPerBlock_catch_eyeTrackerReplay.mat
        outputFilePattern = 'Sub%02d_TrialStruct_v19_threeRunsPerBlock_catch_eyeTrackerReplay.mat';
    end
end

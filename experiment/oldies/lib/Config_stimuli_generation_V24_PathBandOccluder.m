classdef Config_stimuli_generation_V24_PathBandOccluder
    properties(Constant)
        ...
        %   "cd('/Users/damiano/Documents/UniTn/Dynamo/Attention/DAD/experiment'); ...
        %    addpath('lib/'); run('stimuli_generation_V24_PathBandOccluder.m');"
        %
        % Key assumptions:
        ...
        dotSpeedDegPerFrame = Config_stimuli_generation_V24_PathBandOccluder.dotSpeedDegPerSec / ...
            Config_stimuli_generation_V24_PathBandOccluder.frameFrequency;
        ...
        pathBandWidthDeg = max( ...
            Config_stimuli_generation_V24_PathBandOccluder.dotWidth * ...
            Config_stimuli_generation_V24_PathBandOccluder.pathBandWidthMultiplier, ...
            Config_stimuli_generation_V24_PathBandOccluder.dotWidth + ...
            Config_stimuli_generation_V24_PathBandOccluder.pathBandMinMarginDeg);
        ...
        fixationExclusionRadiusDeg = ...
            (Config_stimuli_generation_V24_PathBandOccluder.fixationCrossSizeDegApprox / 2) + ...
            (Config_stimuli_generation_V24_PathBandOccluder.dotWidth / 2) + ...
            Config_stimuli_generation_V24_PathBandOccluder.fixationSafetyMarginDeg;
        ...
        % Fixed-frame occlusion timing controls for the V24 paradigm.
        ...
        likelihood = struct( ...
            'pathDuration', Config_stimuli_generation_V24_PathBandOccluder.trialDuration, ...
            'directionVariance', [0, 45], ...
            'directionChange', 30, ...
            'deviantSignedTurnWindows', ...
            Config_stimuli_generation_V24_PathBandOccluder.deviantSignedTurnWindows);
        ...
        % Example: subject 66 -> MovDot_Sub66_V24_PathBandOccluder.mat
        observedFilePattern = 'MovDot_Sub%02d_V24_PathBandOccluder.mat';
        % Example: subject 66 -> MovDot_Sub66_V24_PathBandOccluder_predicted.mat
        predictedFilePattern = 'MovDot_Sub%02d_V24_PathBandOccluder_predicted.mat';
    end
end

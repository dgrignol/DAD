classdef Config_schedule_CreateInputV16_MoveDotV13_NotWiredOccluder
    properties(Constant)

        % CONFIG_SCHEDULE_CREATEINPUTV16_MOVEDOTV13_NOTWIREDOCCLUDER
        %
        % Purpose:
        %   Centralize block/run schedule controls and catch-trial controls
        %   for:
        %     - experiment/CreateInputFiles_v16_threeRunsPerBlock_catch_NotWiredOccluder.m
        %     - experiment/MoveDot1_experiment_occlusion_v13_NotWiredOccluder.m
        %
        % Usage example (interactive):
        %   In MATLAB, open this file and set:
        %       Config_schedule_CreateInputV16_MoveDotV13_NotWiredOccluder.numBlocks
        %   then run:
        ...
        %    iSub=66; randomSeed=6601; run('CreateInputFiles_v16_threeRunsPerBlock_catch_NotWiredOccluder.m');"
        %
        % Scheduling model:
        ...
        % Run-color cue switch for experiment v13.
        ...
        % Input/output naming for additive v16 schedule artifacts.
        % Input stimulus filename pattern.
        % Example: subject 66 -> MovDot_Sub66_V23_NotWiredOccluder.mat
        inputFilePattern = 'MovDot_Sub%02d_V23_NotWiredOccluder.mat';
        % Output schedule filename pattern.
        % Example: subject 66 -> Sub66_TrialStruct_v16_threeRunsPerBlock_catch_NotWiredOccluder.mat
        outputFilePattern = 'Sub%02d_TrialStruct_v16_threeRunsPerBlock_catch_NotWiredOccluder.mat';
    end
end

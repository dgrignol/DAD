classdef Config_schedule_CreateInputV15_MoveDotV9
    properties(Constant)

        % CONFIG_SCHEDULE_CREATEINPUTV15_MOVEDOTV9
        %
        % Purpose:
        %   Centralize block/run schedule controls and catch-trial controls
        %   for:
        %     - experiment/CreateInputFiles_v15_threeRunsPerBlock_catch.m
        %     - experiment/MoveDot1_experiment_occlusion_v9_addedPracticeMode.m
        %     - experiment/MoveDot1_experiment_occlusion_v5_sequenceTriggers.m
        %
        % Usage example (interactive):
        %   In MATLAB, open this file and set:
        %       Config_schedule_CreateInputV15_MoveDotV9.numBlocks
        %   then run:
        ...
        %    iSub=66; randomSeed=6601; run('CreateInputFiles_v15_threeRunsPerBlock_catch.m');"
        %
        % Scheduling model:
        ...
        run1TransitionMessageDurationSec = 7.0;
        ...
        % Run-color cue switch for experiment v9.
        ...
        % Input/output naming for additive v15 schedule artifacts.
        ...
        % Example: subject 66 -> Sub66_TrialStruct_v15_threeRunsPerBlock_catch.mat
        outputFilePattern = 'Sub%02d_TrialStruct_v15_threeRunsPerBlock_catch.mat';
    end
end

% Config_runtime_v16_eyeTrackerReplay.m
%
% Purpose:
...
%   run('lib/Config_runtime_v16_eyeTrackerReplay.m');
...
%     Config_schedule_CreateInputV19_MoveDotV16_eyeTrackerReplay.
...
%     and all optional override variables supported by v16.
...
fprintf(['Loaded runtime preset for MoveDot1 v16 eyeTrackerReplay: ' ...
    'SUB=%02d BLOCK=%02d practice=%d dryRun=%d debugRun=%s entranceStyle=%s\n'], ...
    iSub, iBlock, practice_mode, double(dryRunValidateScheduleOnly), ...
    mat2str(debug_runNumber), char(pathBandEntranceStyle));

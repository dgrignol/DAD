classdef Config_schedule_CreateInputV17_MoveDotV14_PathBandOccluder
    properties(Constant)

        % CONFIG_SCHEDULE_CREATEINPUTV17_MOVEDOTV14_PATHBANDOCCLUDER
        %
        % Purpose:
        %   Centralize block/run schedule controls and catch-trial controls
        %   for:
        %     - experiment/CreateInputFiles_v17_threeRunsPerBlock_catch_PathBandOccluder.m
        %     - experiment/MoveDot1_experiment_occlusion_v14_PathBandOccluder.m
        %
        % Usage example (interactive):
        %   In MATLAB, open this file and set:
        %       Config_schedule_CreateInputV17_MoveDotV14_PathBandOccluder.numBlocks
        %   then run:
        ...
        % Run-color cue switch for experiment v14.
        ...
        % Input/output naming for additive v17 schedule artifacts.
        % Input stimulus filename pattern.
        % Example: subject 66 -> MovDot_Sub66_V24_PathBandOccluder.mat
        inputFilePattern = 'MovDot_Sub%02d_V24_PathBandOccluder.mat';
        % Output schedule filename pattern.
        % Example: subject 66 -> Sub66_TrialStruct_v17_threeRunsPerBlock_catch_PathBandOccluder.mat
        outputFilePattern = 'Sub%02d_TrialStruct_v17_threeRunsPerBlock_catch_PathBandOccluder.mat';
    end
end

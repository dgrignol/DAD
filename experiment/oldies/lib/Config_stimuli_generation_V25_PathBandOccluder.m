classdef Config_stimuli_generation_V25_PathBandOccluder
    properties(Constant)
        ...
        %     - experiment/stimuli_generation_V25_PathBandOccluder.m
        %
        ...
        %   "cd('/Users/damiano/Documents/UniTn/Dynamo/Attention/DAD/experiment'); ...
        %    addpath('lib/'); run('stimuli_generation_V25_PathBandOccluder.m');"
        %
        % Key assumptions:
        ...
        dotSpeedDegPerFrame = Config_stimuli_generation_V25_PathBandOccluder.dotSpeedDegPerSec / ...
            Config_stimuli_generation_V25_PathBandOccluder.frameFrequency;
        ...
        pathBandWidthDeg = max( ...
            Config_stimuli_generation_V25_PathBandOccluder.dotWidth * ...
            Config_stimuli_generation_V25_PathBandOccluder.pathBandWidthMultiplier, ...
            Config_stimuli_generation_V25_PathBandOccluder.dotWidth + ...
            Config_stimuli_generation_V25_PathBandOccluder.pathBandMinMarginDeg);
        ...
        fixationExclusionRadiusDeg = ...
            (Config_stimuli_generation_V25_PathBandOccluder.fixationCrossSizeDegApprox / 2) + ...
            (Config_stimuli_generation_V25_PathBandOccluder.dotWidth / 2) + ...
            Config_stimuli_generation_V25_PathBandOccluder.fixationSafetyMarginDeg;
        ...
        % Fixed-frame occlusion timing controls for the V25 paradigm.
        ...
        likelihood = struct( ...
            'pathDuration', Config_stimuli_generation_V25_PathBandOccluder.trialDuration, ...
            'directionVariance', [0, 45], ...
            'directionChange', 30, ...
            'deviantSignedTurnWindows', ...
            Config_stimuli_generation_V25_PathBandOccluder.deviantSignedTurnWindows);
        ...
        % Example: subject 66 -> MovDot_Sub66_V25_PathBandOccluder.mat
        observedFilePattern = 'MovDot_Sub%02d_V25_PathBandOccluder.mat';
        % Example: subject 66 -> MovDot_Sub66_V25_PathBandOccluder_predicted.mat
        predictedFilePattern = 'MovDot_Sub%02d_V25_PathBandOccluder_predicted.mat';
    end
end

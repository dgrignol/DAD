...
| 151 | Replay start | Sent once per block, immediately before the first replayed trial in that block begins (after a gaze break). A 100 ms pause follows the pulse before the replay trial proceeds. |
